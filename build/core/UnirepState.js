    ...
    constructor(_setting, _currentEpoch, _latestBlock, _GSTLeaves, _epochTreeLeaves, _epochKeyToAttestationsMap, _nullifiers) {
        ...
        */
        this._isEpochKeySealed = (epochKey) => {
            (0, assert_1.default)(!this.isEpochKeySealed(epochKey), `UnirepState: Epoch key (${epochKey}) has been sealed`);
        };
        /*
        ...
        */
        ...
        this.epochTransition = async (epoch, blockNumber) => {
            ...
            this.globalStateTree[this.currentEpoch] = new crypto_1.IncrementalQuinTree(this.setting.globalStateTreeDepth, this.defaultGSTLeaf, 2);
        ...
        if (_GSTLeaves !== undefined) {
            ...
            for (let key in this.GSTLeaves) {
                this.globalStateTree[key] = new crypto_1.IncrementalQuinTree(this.setting.globalStateTreeDepth, this.defaultGSTLeaf, 2);
